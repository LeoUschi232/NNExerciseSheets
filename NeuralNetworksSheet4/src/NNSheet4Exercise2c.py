...
def inverse_type2(aa1, aa2, aa3, ll):
    print("Alpha alternate:", alpha_alt(aa1, aa2, aa3))
    return array(linalg.inv(array(alpha_main(aa1, aa2, aa3)) + ll * array(alpha_alt(aa1, aa2, aa3))))
...
for i in range(1, max_depth):
    ...
    inv_array = array(inverse_type2(a[0], a[1], a[2], l))
